...
const updateUI = function (data) {
  ...
  <div class="container-left">
      ...
      <div class="container-right__heading">
        <h2 class="person-name">${data.name}</h2>
        <p class="person-dateOfJoin">Joined: ${dayjs(data.created_at).format(
          "D-MMM-YYYY"
        )}</p>
        <p class="person-userName">@${data.login}</p>
        </div>

      <div class="person-bio">${data.bio}</div>
    ...
    <div class="container-info">
      <div class="container-info__location container-info__flex">
        ...
        <p class="container-info__text location">${verifyValue(
          data.location
        )}</p>
      </div>
      <div class="container-info__location container-info__flex">
